import { BGAtomPlugin, BGRemoveKeybindings, BGFindWorkspaceItemFromURI } from 'bg-atom-utils';
...
//		this.disposables.add(this.tabFontSizerWorkSpcCenter, this.tabFontSizerLeftDock, this.tabFontSizerRightDock, this.tabFontSizerBottomDock)
		...
		this.watchConfig('bg-ui-font-sizer.enable-global-keymaps', ()=>{this.onGlobalKeymapsConfigChange()});
		this.watchConfig('core.packagesWithKeymapsDisabled',       ()=>{this.onGlobalKeymapsConfigChange()});
	}
